...
//Records with code and comments
var queryString_java = "SELECT webex21.ent_dissection.rdfID as rdfid, webex21.ent_dissection.Name as title, webex21.ent_dissection.domain, webex21.ent_dissection.Author as author_id, webex21.ent_user.name author, webex21.ent_line.Code AS code, webex21.ent_line.Comment AS comment, webex21.ent_line.LineIndex AS line "
    + "FROM webex21.ent_dissection,webex21.ent_line,webex21.rel_dissection_privacy,webex21.ent_user "
    + "WHERE webex21.ent_line.DissectionID=webex21.ent_dissection.DissectionID "  //to fetch the lines from ent_line
    + "AND webex21.ent_dissection.DissectionID=webex21.rel_dissection_privacy.DissectionID "  //to fetch privacy from re_dissection_privacy
    + "AND webex21.rel_dissection_privacy.privacy = 1 "  //to fetch only public content
    + "AND webex21.ent_dissection.author = webex21.ent_user.login;"
        ...
        for(var i = 0; i < data.length; i++) {
            ...
            if (domain == 'java'){
                if (line == "1")
                {
                    ...
                    annotated_java[rdfid].author_id = data[i].author_id;
                    annotated_java[rdfid].keywords = [title,'annotated example'];
                    annotated_java[rdfid].subitems = [];
                    annotated_java[rdfid].subitems.push({"name":data[i].line,"code":data[i].code,"comment":data[i].comment});
                }
                else
                {
                ...
                if (line == "1")
                {
                    ...
                    annotated_py[rdfid].author_id = data[i].author_id;
                    annotated_py[rdfid].keywords = [title,'annotated example'];
                    annotated_py[rdfid].subitems = [];
                    annotated_py[rdfid].subitems.push({"name":data[i].line,"code":data[i].code,"comment":data[i].comment});
                }
                else
                {
                    //add code lines and comments to existing object in windows.annotated
                ...
                if (line == "1")
                {
                    ...
                    annotated_sql[rdfid].author_id = data[i].author_id;
                    annotated_sql[rdfid].keywords = [title,'annotated example'];
                    annotated_sql[rdfid].subitems = [];
                    annotated_sql[rdfid].subitems.push({"name":data[i].line,"code":data[i].code,"comment":data[i].comment});
                }
                else
                {
                    //add code lines and comments to existing object in windows.annotated
                ...
                if (line == "1")
                {
                    ...
                    annotated_c[rdfid].author_id = data[i].author_id;
                    annotated_c[rdfid].keywords = [title,'annotated example'];
                    annotated_c[rdfid].subitems = [];
                    annotated_c[rdfid].subitems.push({"name":data[i].line,"code":data[i].code,"comment":data[i].comment});
                }
                else
                {
                    //add code lines and comments to existing object in windows.annotated
                ...
                if (line == "1")
                {
                    ...
                    annotated_cpp[rdfid].author_id = data[i].author_id;
                    annotated_cpp[rdfid].keywords = [title,'annotated example'];
                    annotated_cpp[rdfid].subitems = [];
                    annotated_cpp[rdfid].subitems.push({"name":data[i].line,"code":data[i].code,"comment":data[i].comment});
                }
                else
                {
                    //add code lines and comments to existing object in windows.annotated
                ...
                if (line == "1")
                {
                    ...
                    annotated_vb[rdfid].author_id = data[i].author_id;
                    annotated_vb[rdfid].keywords = [title,'annotated example'];
                    annotated_vb[rdfid].subitems = [];
                    annotated_vb[rdfid].subitems.push({"name":data[i].line,"code":data[i].code,"comment":data[i].comment});
                }
                else
                {
                    //add code lines and comments to existing object in windows.annotated
