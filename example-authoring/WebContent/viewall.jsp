...
%>
		...
		<tr>
			<td width="50%">
			<table width="100%">
			<tr><td class="classbox">all examples:</td></tr>
			<tr><td>
			<table width="99%">
		<%
	...
	try{									
		String sql1 = "SELECT * FROM rel_scope_dissection where ScopeID = '1' ";	
		...
		%>									              									 								
		 ...
		 <tr><td><a href="<%="EditExample.jsp?exampleno="+rs1.getString(2)%>"><%=rs2.getString(2)%></a></td>
					<td width="5%">
