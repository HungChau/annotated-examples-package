...
<% 		if (!userBean.isAdmin()) {
%>			You do not have sufficient rights to perform this operation. Only <a href="mailto:sas15@pitt.edu">System Administrator</a> can delete users.<br/>
...
%>
			<form name="formDeleteUser" id="formDeleteUser" method="post" action="SecurityServlet?action=DELETEUSER" onSubmit="return confirm('Are you sure you want to delete this user?');" >
